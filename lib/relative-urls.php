 ...
 */
function skeleton_root_relative_url($input) {
...
if (skeleton_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'skeleton_root_relative_url');
}
