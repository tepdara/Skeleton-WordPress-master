<?php
/**
 * Skeleton initial setup and constants
 */
function skeleton_setup() {
  ...
  register_nav_menus(array(
    'primary_navigation' => __('Primary Navigation', 'skeleton'),
    'secondary_navigation' => __( 'Secondary Navigation', 'skeleton' ),
  ));
...
// Redirect login to wp-login.php
